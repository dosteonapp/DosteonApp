        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <Button variant="outline" asChild>
              <Link href="/restaurant/finance/export">
                ...
                >
                  <ResponsiveContainer width="100%" height="100%">
                    <LineChart data={spendingData} margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
                      ...
                      <Legend />
                      <Line type="monotone" dataKey="spending" stroke="var(--color-spending)" name="Spending" />
                      <Line
                        type="monotone"
                        dataKey="budget"
                        ...
                        <TableRow key={transaction.id}>
                          ...
                          <TableCell className="text-right">
                            <Button size="sm" variant="ghost" asChild>
                              <Link href={`/restaurant/finance/transactions/${transaction.id}`}>
                        ...
                        <TableRow key={invoice.id}>
                          ...
                          <TableCell className="text-right">
                            <div className="flex justify-end gap-2">
                              ...
                              {invoice.status === "Pending" && <Button size="sm">Pay</Button>}
                            </div>
                          </TableCell>
                        </TableRow>
                      ))}
          ...
          <TabsContent value="budget" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Manage your procurement budget</CardDescription>
              </CardHeader>
              <CardContent>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <Card>
                      ...
                      <CardContent>
                        ...
                        <p className="text-xs text-muted-foreground">RWF 12,450,000 spent this month</p>
                        <div className="mt-2 h-2 w-full bg-muted rounded-full overflow-hidden">
                          <div className="bg-primary h-full" style={{ width: "83%" }}></div>
                        </div>
                        <p className="text-xs text-muted-foreground mt-1">83% of budget used</p>
                      </CardContent>
                    </Card>
                    <Card>
                      <CardHeader className="pb-2">
                      ...
                      <CardContent>
                        <div className="text-2xl font-bold">RWF 180,000,000</div>
                        <p className="text-xs text-muted-foreground">RWF 65,230,000 spent this year</p>
                        <div className="mt-2 h-2 w-full bg-muted rounded-full overflow-hidden">
                          <div className="bg-primary h-full" style={{ width: "36%" }}></div>
                        </div>
                        <p className="text-xs text-muted-foreground mt-1">36% of budget used</p>
                      </CardContent>
                    </Card>
                  </div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4 mb-6">
                  ...
                  <Card>
                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                      <CardTitle className="text-sm font-medium">Last Replenishment</CardTitle>
                    </CardHeader>
                    <CardContent>
