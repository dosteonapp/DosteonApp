              ...
              return (
                <Form className="space-y-4">
                  ...
                  <div className="flex flex-col sm:flex-row gap-3">
                    <Button type="button" variant="outline" onClick={() => authenticateWithGoogle()} className="flex-1 h-12 flex items-center justify-center gap-2 border-gray-300 text-gray-700">
                      <img src="/images/google-icon.svg" alt="Google" className="w-5 h-5" />
                      Google
                    </Button>
                    <Button type="button" variant="outline" onClick={() => authenticateWithApple()} className="flex-1 h-12 flex items-center justify-center gap-2 border-gray-300 text-gray-700">
