...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-[#f7f7f8] flex flex-col">
      {/* Header */}
      <header
        className="w-full bg-white shadow rounded-xl mt-4 mx-auto max-w-6xl flex items-center justify-between px-8 py-4"
      ...
      <main className="flex-1 flex flex-col items-center justify-center">
        <form
          ...
          className="bg-white rounded-2xl shadow-lg p-10 w-full max-w-xl flex flex-col gap-6"
        >
